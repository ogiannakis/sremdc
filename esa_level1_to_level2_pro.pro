...
IF i_srem_unit eq 2 THEN restore,'/home/omiros/sremdc/esa/data/SREM_DATA/SREM/SREM_GF_INTEGRAL.idat'
...
;bb=cnts[*,it] & dex=where(total(finite(bb,/NAN)) GT 0, n) 
;If (n GT 0) then goto,outputs
...
;--------------------------------------------------------------------------------------------;
SREM_FLUX_PRODUCT=COUNTS_TO_FLUXES(cnts, i_srem_unit)
help,SREM_FLUX_PRODUCT
return,SREM_FLUX_PRODUCT
end
...
pro esa_level1_to_level2_pro
; EXAMPLE
dirname='/home/omiros/sremdc/esa/input/'

;pacc_file1='IREM_PACC_20050117_ESA_L1_P01.cdf'
pacc_file1='IREM_PACC_20050218_ESA_L1_V01.cdf'
;pacc_file3='.......cdf'

SREM_FLUX_PRODUCT=ESA_LEVEL1_to_LEVEL2(dirname,pacc_file1)

; contents
;SREM_FLUX_PRODUCT=create_struct('FPDO',FPDO,'FEDO',FEDO,'FPDO_ENERGY',FPDO_ENERGY,'FEDO_ENERGY',FEDO_ENERGY,'FPDO_ENERGY_bou',FPDO_ENERGY_bou,'FEDO_ENERGY_bou',FEDO_ENERGY_bou,'PARTICLE_INDEX',PARTICLE_INDEX,'GFP',GFP,'GFE',GFE)


;------------------------------------------------------------------;
;--------Save the extracted variables from FSVD to SAV files-------;
;------------------------------------------------------------------;
SAVE, SREM_FLUX_PRODUCT.FPDO, SREM_FLUX_PRODUCT.FEDO, SREM_FLUX_PRODUCT.FPDO_ENERGY, SREM_FLUX_PRODUCT.FEDO_ENERGY, SREM_FLUX_PRODUCT.FPDO_ENERGY_BOU, SREM_FLUX_PRODUCT.FEDO_ENERGY_BOU, SREM_FLUX_PRODUCT.PARTICLE_INDEX, SREM_FLUX_PRODUCT.GFP, SREM_FLUX_PRODUCT.GFE, /VARIABLES, FILENAME='/home/omiros/sremdc/esa/output/FSVD.sav'
;Restore the SAV file
RESTORE, '/home/omiros/sremdc/esa/output/FSVD.sav'
END
