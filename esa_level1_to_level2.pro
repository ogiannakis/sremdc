...
;-------------------------------------------------;
;for the AUSTRIAN SERVER DELETE DIR ' /omiros '
PACC_file='/home/omiros/sremdc/esa/input/IREM_PACC_20050117_ESA_L1_P01.cdf'
I=0
...
;------------------------------------------------------------------;
SAVE, fluxes_info.FPDO, fluxes_info.FEDO, fluxes_info.FPDO_ENERGY, fluxes_info.FEDO_ENERGY, fluxes_info.FPDO_ENERGY_BOU, fluxes_info.FEDO_ENERGY_BOU, fluxes_info.PARTICLE_INDEX, fluxes_info.GFP, fluxes_info.GFE, /VARIABLES, FILENAME='/home/omiros/sremdc/esa/output/FSVD.sav'
